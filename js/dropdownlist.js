...
var DropDownList = (function($, undefined) {
    ...
    DDLClass.prototype = {
        ...
        _init: function(configs) {
            ...
            attrs['data-cols'] = this.configs.attrs.row || 8;
        ...
        show: function() {
            ...
            var tmpStyles = {
                ...
                'width': parent[0].offsetWidth - (parseInt(parent.css('border-left-width'), 10) || 0) - (parseInt(parent.css('border-right-width'), 10) || 0),
     ...
     * @p-c-config  {String}    row      自定义下拉框中的option显示行数，默认显示10行
